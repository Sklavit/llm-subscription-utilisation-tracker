...
# LaunchAgents, run an initial backfill. Re-run any time after editing track.py.
set -euo pipefail
...
echo "==> Deploying track.py to $ARCHIVE_DIR"
mkdir -p "$ARCHIVE_DIR"
cp "$HERE/track.py" "$ARCHIVE_DIR/track.py"
